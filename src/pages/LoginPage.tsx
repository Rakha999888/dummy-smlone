  ...
  return (
    <>
      ...
      <div className="relative flex flex-col lg:flex-row min-h-screen w-full bg-[#f4f7fc] font-sans selection:bg-blue-200">
        ...
        <div className="absolute inset-0 lg:relative lg:w-1/2 lg:flex-none lg:min-h-screen overflow-hidden z-0">
          <div className="absolute inset-0 bg-blue-900/10 mix-blend-multiply z-10 hidden lg:block" />
          <img
            src="/asset/foto.png"
            alt="Students"
            aria-hidden="true"
            ...
            className="hidden lg:block absolute inset-0 w-full h-full object-cover object-center select-none pointer-events-none"
          />
          <div className="absolute inset-0 lg:hidden pointer-events-none">
            <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-[#f4f7fc] z-10" />
            <img
              src="/asset/foto 1.png"
              alt=""
              aria-hidden="true"
              draggable={false}
              className="absolute top-0 left-0 w-full h-auto object-cover object-top select-none"
            />
          </div>
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12 z-20">
        ...
        <div className="absolute bottom-6 left-0 w-full text-center z-30 lg:left-1/2 lg:w-1/2 px-4 pointer-events-none">
